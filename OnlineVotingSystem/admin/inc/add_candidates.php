...
?>
    <div class="alert alert-danger my-3" role="alert">
        Candidate image too large, Please upload smaller size!!
    </div>
<?php
} else if (isset($_GET['invalidFile'])) {
?>
    <div class="alert alert-danger my-3" role="alert">
        Invalid image! (Only .jpg, .jpeg or .png files are allowed.)
    </div>
<?php
    ...
    <div class="col-4">
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <p>Upto 2mb in jpg,jpeg or png format</p>
            </div>
            <div class="form-group">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                ?>
                        <tr>
                            <td><?php echo $sno++; ?></td>
                            <td> <img src=" <?php echo $candidate_photo; ?>" style="border-radius:50%; height:80px;width:80px;border: 3px solid #DD007F;" /></td>
                    ...
                    ?>
                    <tr>
                        <td colspan="7"> Any Candidate is not added yet!! </td>
                    </tr>
...
if (isset($_POST['addCandidateBtn'])) {
    ...
    $candidate_photo = $targetted_folder . rand(111111111, 99999999999999) . "_" . rand(111111111, 99999999999999) . $_FILES['candidate_photo']['name'];
