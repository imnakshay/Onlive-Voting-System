    ...
    <div class="col-12">
        ...
        ?>
                ...
                <table class="table">
                    <thead>
                        <tr>
                            <th colspan="4" style="background-color: #FF5E07;color:white;">
                    ...
                    <tbody>
                        ...
                        ?>
                            ...
                            <tr>
                                <td> <img src="<?php echo $candidate_photo; ?>" style="height:80px;width:80px;border-radius:100%;"/> </td>
                                ...
                                <?php
                                    ...
                                    if ($isVoteCasted > 0)
                                    {
                                        ...
                                        {
                                ?>
                                            <img src="../assets/images/votedLogo.png" width="40px" height="40px">
