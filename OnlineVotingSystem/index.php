		...
		<div class="d-flex justify-content-center h-100">
			<div class="user_card">
				...
				?>
					<div class="d-flex justify-content-center form_container">
						<form method="POST">
							...
							<div class="input-group mb-2">
								...
								<input type="text" name="su_contact_no" class="form-control input_pass" placeholder="Mobile No." required />
							</div>
							<div class="input-group mb-2">
								<div class="input-group-append">
									<span class="input-group-text"><i class="fas fa-key"></i></span>
					...
					<div class="mt-4">
						<div class="d-flex justify-content-center links text-white">
							Already have account? <a href="index.php" class="ml-2 text-green">Sign In</a>
						</div>
					</div>
				<?php
				} else {
				?>
					...
					<div class="mt-4">
						<div class="d-flex justify-content-center links text-white">
							Don't have an account? <a href="?sign-up=1" class="ml-2 text-green">Sign Up</a>
						</div>
						<div class="d-flex justify-content-center links">
							<a href="#" class="text-red">Forgot your password?</a>
						</div>
					</div>
				<?php
				}
				...
				?>
					...
					<span class="bg-white text-danger text-center my-3"> Password Miss-match!! </span>
				<?php
				} else if (isset($_GET['not_registered'])) {
				?>

					<span class="bg-white text-warning text-center my-3"> You are not registerd!! </span>
				<?php
				} else if (isset($_GET['invalid_access'])) {
				?>

					<span class="bg-white text-danger text-center my-3"> Invalid mobile no. or Password!! </span>
				<?php
				}
				?>
...
<font color="white"> <?php echo "hello"; ?> </font>
